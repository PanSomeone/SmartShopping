	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="jumbotron">
					<h1>欢迎来到智购</h1>
					<p>智购 —— 您的专属校园宿舍购物平台。专为荟园99栋打造，零食饮料即刻送达，让大学生活更便捷！</p>
				</div>
              ...
              $.ajax({
                  ...
                  success: function(result) {
                      if (result.type === 'recommend') {
                          ...
                          var html = '<div style="background: #e1f5fe; padding: 8px; border-radius: 5px; align-self: flex-start; max-width: 80%;">' +
                                     result.message + '<br>' +
                                     '<img src="${cp}/img/' + p.img + '" style="width:50px;display:block;margin:5px 0;">' +
                                     '<button onclick="addToCart(' + p.id + ')" style="background:#5cb85c;color:white;border:none;padding:5px;border-radius:3px;cursor:pointer;">加入购物车</button>' +
                                     '</div>';
                          content.innerHTML += html;
                      } else {
                          content.innerHTML += '<div style="background: #e1f5fe; padding: 8px; border-radius: 5px; align-self: flex-start; max-width: 80%;">' + result.message + '</div>';
                      }
