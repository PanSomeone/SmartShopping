  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-offset-2 col-md-offest-2">
            ...
            <div  class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="address" class="col-sm-2 col-md-2 control-label">宿舍号</label>
                    <div class="col-sm-6 col-md-6">
                        <select class="form-control" id="address">
                            <% for(int i=1; i<=100; i++) { %>
                                <option value="<%= String.format("%03d", i) %>"> <%= String.format("%03d", i) %> 号宿舍</option>
                            <% } %>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-6">
                        ...
                        <button class="btn btn-lg btn-primary btn-block" type="submit" onclick="becomeBoss()" >成为商家</button>
                    </div>
                </div>
            </div>
            <br/>
    ...
    <script type="text/javascript">
        ...
        function startRegister() {
            ...
            user.postNumber = "000000"; // 简化流程，固定邮编
            user.birthday = "2000-01-01"; // 简化流程，固定生日
            user.address = document.getElementById("address").value; // 选择了宿舍号
            user.sex = document.getElementById("woman").checked ? 1 : 0;
