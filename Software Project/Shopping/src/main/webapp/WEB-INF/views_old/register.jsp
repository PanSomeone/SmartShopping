    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-offset-2 col-md-offest-2">
            ...
            <div  class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="address" class="col-sm-2 col-md-2 control-label">宿舍编号</label>
                    <div class="col-sm-6 col-md-6">
                        <select class="form-control" id="address">
                            <option value="">请选择宿舍号 (001-100)</option>
                            <script>
                                for(var i=1; i<=100; i++) {
                                    var val = i.toString().padStart(3, '0');
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-6">
                        <button class="btn btn-lg btn-primary btn-block" type="submit" onclick="becomeVip()" >成为vip买家</button>
                        <button class="btn btn-lg btn-primary btn-block" type="submit" onclick="startRegister()">成为买家</button>
